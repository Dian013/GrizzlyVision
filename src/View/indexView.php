...
<body>
    ...
    <header>
        <div id="top_header">
            ...
            <nav>
                <div id="search_bar">
                    ...
                    <input type="search" name="search_input" placeholder="Rechercher...">
                </div>
        ...
        <div id="switch_mod">
            <button id="switch_mod_img_vid" class="switch__mod__button">
                <span></span>
            </button>
            <ul>
                <li><i class="fa-solid fa-image"></i></li>
                <li><i class="fa-solid fa-film"></i></li>
                <li><i class="fa-solid fa-photo-film switch__mod--choice"></i></li>
            </ul>
        </div>
    </header>
